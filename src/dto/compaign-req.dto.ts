...
export class CampaignRequestDTO {
    @ApiProperty({ example: 'step1', description: 'Current step of the campaign' })
    @IsOptional()
    @IsString()
    step?: string
    ...
    @ApiProperty({ example: 'https://example.com/token.jpg', description: 'Token image URL' })
    @IsOptional()
    @IsString()
    token_image?: string
    ...
    @ApiProperty({ example: 'This is a description of the token.', description: 'Description of the token' })
    @IsOptional()
    @IsString()
    token_desc?: string
    ...
    @ApiProperty({ example: 'https://tokenwebsite.com', description: 'Token website URL' })
    @IsOptional()
    @IsString()
    token_website?: string

    @ApiProperty({ example: '@tokenTwitter', description: 'Token Twitter handle' })
    @IsOptional()
    @IsString()
    twitter?: string

    @ApiProperty({ example: 'https://discord.com/invite/token', description: 'Token Discord URL' })
    @IsOptional()
    @IsString()
    discord?: string
    ...
    @ApiProperty({ example: 'This is a description of the campaign.', description: 'Description of the campaign' })
    @IsOptional()
    @IsString()
    campaign_description?: string

    @ApiProperty({ example: '@campaignTwitter', description: 'Campaign Twitter handle' })
    @IsOptional()
    @IsString()
    campaign_twitter?: string

    @ApiProperty({ example: '#campaign #launch', description: 'Campaign hashtags' })
    @IsOptional()
    @IsString()
    ...
    @ApiProperty({ example: 'This is a description of the sale.', description: 'Description of the sale' })
    @IsOptional()
    @IsString()
